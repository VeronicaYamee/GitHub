...
A tick is an arbitrary unit for measuring system time. The number of ticks per second (the tick rate) is the frequency of the system timer and it is measured in hertz. One second is ten million ticks.
