...
The output messages were shown previously in Figure x. The first column represents the acceleration on x-axis, the second column is the acceleration on y-axis and the third column is the acceleration on z-axis and the fourth column is the temperature.
